    ...
    <div class="row-fluid sortable">		
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                @foreach ($all_products_info as $v_product)
                      
                  <tbody>
                      <tr>
                      <td>{{ $v_product->product_id }}</td>
                          <td class="center">{{ $v_product->product_name }}</td>
                          <td><img src="{{ $v_product->product_image }}" alt="img" style="height: 100px; width:100px;"></td>
                          ...
                          <td class="center">
                            ...
                            <td class="center">
                            @if ($v_product->publication_status == 1)
                            <a class="btn btn-danger" href="{{ url('/inactive-product/'.$v_product->product_id) }}">
