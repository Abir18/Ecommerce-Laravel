    ...
    <div class="product-image-wrapper">
        <div class="single-products">
                <div class="productinfo text-center">
                    ...
                    <img src="{{URL::to($v_published_product->product_image)}}" alt="" height="250px" width="200px"/>
                    <h2>Tk {{ $v_published_product->product_price }} BDT</h2>
                    <h4>{{ $v_published_product->product_name }}</h4>
                    <a href="{{ url('/view-product/'. $v_published_product->product_id) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
        ...
        <div class="choose">
            ...
            <li><a href="{{ url('/view-product/'. $v_published_product->product_id) }}"><i class="fa fa-plus-square"></i>View Product</a></li>
            </ul>
        </div>
    </div>
</div>
