        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                    <div class="productinfo text-center">
                        ...
                        <img src="{{URL::to($v_category_by_product->product_image)}}" alt="" height="250px" width="200px"/>
                        <h2>Tk {{ $v_category_by_product->product_price }} BDT</h2>
                        <h4>{{ $v_category_by_product->product_name }}</h4>
