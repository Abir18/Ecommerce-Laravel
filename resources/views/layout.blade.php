					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<?php foreach($all_published_category as $v_category) { ?>
								<div class="panel panel-default">
									...
									<h4 class="panel-title"><a href="{{ url('/product-by-category/' .$v_category->category_id) }}">{{ $v_category->category_name }}</a></h4>
									</div>
								</div>
							<?php } ?>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<?php foreach($all_published_manufacture as $v_manufacture) { ?>
								<li><a href="{{ url('/product-by-manufacture/' .$v_manufacture->manufacture_id) }}"> <span class="pull-right"></span>{{ $v_manufacture->manufacture_name }}</a></li>
							<?php } ?>
