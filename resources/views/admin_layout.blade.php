		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					...
					<li><a href="{{ route('add-category') }}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Categories</span></a></li>
						...
						{{-- <a><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet"> Social Link</span></a></a>
